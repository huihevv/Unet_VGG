...
def vgg19():
    ...
    model_vgg19 = Model(inputs=b_model.input, outputs=[ b_model.get_layer('block1_conv1').output,
                                                        b_model.get_layer('block1_conv2').output,
                                                        b_model.get_layer('block2_conv2').output,
                                                        b_model.get_layer('block2_pool').output])
    return model_vgg19
def unet(vgg):
    input_1 = Input((128, 128, 3))
    conv1_1, conv1, conv2, pool2 = vgg(input_1)
    ...
    model = Model(inputs=input_1, outputs = conv1_1)
